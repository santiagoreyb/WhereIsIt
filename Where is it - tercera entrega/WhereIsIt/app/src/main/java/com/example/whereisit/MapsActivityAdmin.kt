...
import com.example.whereisit.databinding.MapsActivityAdminBinding
...
class MapsActivityAdmin : AppCompatActivity(), OnMapReadyCallback {
    ...
    private lateinit var binding: MapsActivityAdminBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = MapsActivityAdminBinding.inflate(layoutInflater)
        ...
        val activosButton:Button = findViewById(R.id.ActivosButtonID)
        activosButton.setOnClickListener {
            val activosIntent = Intent(this,ListaUsuariosActivity::class.java)
    ...
    private fun leerActivosYAgregarMarcadores() {

        val activosRef = database.getReference("activos")

        activosRef.addListenerForSingleValueEvent(object : ValueEventListener {
            override fun onDataChange(dataSnapshot: DataSnapshot) {
                for (activoSnapshot in dataSnapshot.children) {
                    val activo = activoSnapshot.getValue(ActivoClass::class.java)

                    // Obtener las coordenadas del activo
                    val latitud = activo?.getLatitud()?.toDouble()
                    val longitud = activo?.getLongitud()?.toDouble()
                    ...
                    if (latitud != null && longitud != null) {
                        ...
                        mMap.addMarker(marcadorOptions)
                        ...
                        mMap.setOnMarkerClickListener { marker ->
                            ...
                            val calcularRutaIntent = Intent(this@MapsActivityAdmin, OsmMapActivity::class.java)
            ...
            override fun onCancelled(databaseError: DatabaseError) {
                Log.e("Error", "Error al leer los activos de la base de datos: ${databaseError.message}")
            }
        })
